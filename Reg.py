            ...
            if(len(z.get())) < 5:
                ...
                if s.get().isdigit():
                    ...
                    if cas is None:
                        ...
                        insert()
#label and input
        Label(self,text="Library Management System",font=("Algerian",35,'bold'),fg="white",bg="dark green").place(x=340,y=80)
        Label(self,text="Enter your details and click save",font=("Arial",20,'bold'),fg="white",bg="dark green").place(x=450,y=650)
        d = Frame(self, width=650, height=400, bg="light green").place(x=370, y=180)
        Label(d,text = "Library Information",font = ("Arial",13,"bold"),bg="light green").place(x=600,y=220)
        Label(d, text="User ID", font=("Arial", 13, "bold"), bg="light green").place(x=420, y=260)
        Label(d, text="User - Name", font=("Arial", 13, "bold"), bg="light green").place(x=420, y=300)
        Label(d, text="User - Password", font=("Arial", 13, "bold"), bg="light green").place(x=420, y=340)
        Label(d, text="Security Question", font=("Arial", 13, "bold"), bg="light green").place(x=420, y=380)
        Label(d, text="Security Answer", font=("Arial", 13, "bold"), bg="light green").place(x=420, y=420)
        Label(d, text="Phone", font=("Arial", 13, "bold"), bg="light green").place(x=420, y=460)
        Label(d, text="City", font=("Arial", 13, "bold"), bg="light green").place(x=760, y=460)
